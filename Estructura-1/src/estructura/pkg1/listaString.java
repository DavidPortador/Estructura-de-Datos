...
public class listaString {
    ...
    public listaString(clasString p_str) {
        Nodo v_nodo = new Nodo(p_str);
        v_nodo.insertarPrincipio(p_str);
        ...
        if(a_longitud < 1){
            ...
            System.out.println("\nCabeza: "+v_nodo.obtener(0).getA_texto());
            if(a_longitud == 1)
                System.out.println("Cola: null");
            else
                System.out.println("Cola: "+v_nodo.obtener(a_longitud-1).getA_texto());
        }
        ...
        switch(v_opc){
            case 1:
                ...
                System.out.println("Dato ("+v_dato+") tiene = "
                        + "["+p_nodo.obtener(v_dato).getA_texto()+"]");
                }
                break;
            case 2:
                int v_cont;
                ...
                for(v_cont=0;v_cont<a_longitud;v_cont++){
                    System.out.print(p_nodo.obtener(v_cont).getA_texto());
            ...
            case 3:
                ...
                clasString v_inInicio = new clasString(v_texto);
            ...
            case 4:
                ...
                System.out.print("Dato: ");
                v_texto = a_tec.nextLine();
                clasString v_inFinal = new clasString(v_texto);
            ...
            case 5:
                ...
                if(a_longitud == 1){
                    ...
                    System.out.print("Dato: ");
                    v_texto = a_tec.nextLine();
                    clasString v_xn = new clasString(v_texto);
                    if(v_op==0)
            ...
            default:System.out.println("Selecciones una opcion valida");break;
        }
    }
    // Validación
    ...
    private class Nodo{
        ...
        public clasString a_str;
        // Constructor que recibe el objeto a manipular
        public Nodo(clasString p_str) {
            a_str = p_str;
        }
        void insertarPrincipio(clasString p_str){
        ...
        void insertarFinal(clasString p_str){
            Nodo v_nuevoNodo = new Nodo(p_str);  
        ...
        void insertarXn(int p_num, clasString p_str){ // Posicion especifica
            Nodo v_nuevoNodo = new Nodo(p_str);  
            // Valida que la lista no este vacia
            if (a_cabeza == null)
                a_cabeza = v_nuevoNodo;
